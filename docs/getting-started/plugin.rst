...
You can read how to create a basic plugin by following the steps in the `Official Cadwork Documentation <https://docs.cadwork.com/projects/cwapi3dpython/en/latest/get_started/>`__.
...
Modern Python tools like `uv <https://docs.astral.sh/uv/>`__ or `poetry <https://python-poetry.org/>`__ make environment management effortless.
