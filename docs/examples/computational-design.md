...
This is a simple example of how `compas_cadwork` can fit into a computational design workflow using COMPAS' pure Python geometry kernel.

![Computational design example](../assets/images/dome.gif)

> [!NOTE]
> This example uses the COMPAS Timber extension: [COMPAS Timber](https://gramaziokohler.github.io/compas_timber/).
...
The mesh's edges will become the beams:
