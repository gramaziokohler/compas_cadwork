...
import compas_cadwork.utils.compatibility as compat
...
def test_requires_cadwork_decorator_works_on_methods(monkeypatch) -> None:
    # Running on Cadwork 2026
    monkeypatch.setattr(compat, "CADWORK_VERSION", 2026)
...
def test_requires_cadwork_can_decorate_properties_with_functions(monkeypatch) -> None:
    # Running on Cadwork 2026
    monkeypatch.setattr(compat, "CADWORK_VERSION", 2026)
    instance = make_gated_class()
