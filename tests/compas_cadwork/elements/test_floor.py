...
def test_creates_polygonal_floor(cadwork) -> None:
    ...
    cadwork.ac.set_framed_floor.assert_called_once_with([1122])


def test_creates_rectangular_floor(cadwork) -> None:
    ...
    cadwork.ac.set_framed_floor.assert_called_once_with([1121])
