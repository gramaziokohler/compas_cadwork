...
def test_creates_polygonal_wall(cadwork) -> None:
    ...
    cadwork.ac.set_framed_wall.assert_called_once_with([1122])


def test_creates_rectangular_wall(cadwork) -> None:
    ...
    cadwork.ac.set_framed_wall.assert_called_once_with([1121])
