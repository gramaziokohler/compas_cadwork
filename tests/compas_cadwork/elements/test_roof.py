...
def test_creates_polygonal_roof(cadwork) -> None:
    ...
    cadwork.ac.set_framed_roof.assert_called_once_with([1122])


def test_creates_rectangular_roof(cadwork) -> None:
    ...
    cadwork.ac.set_framed_roof.assert_called_once_with([1121])
