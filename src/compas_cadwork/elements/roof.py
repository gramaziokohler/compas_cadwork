...
class Roof(Panel[Literal[ElementType.ROOF]], LayeredMixin[RoofLayerStack]):
    ...
    @property
    def _layer_stack_type(self) -> type[RoofLayerStack]:
        return RoofLayerStack
